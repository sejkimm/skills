...
Format-only cleanup is optional unless the user asks for it or the target style
guide requires it. Do not treat heavy emphasis or label-led bullet items as
AI-writing signals by default.
...
- Removed em dashes, emojis, and curly quotes
